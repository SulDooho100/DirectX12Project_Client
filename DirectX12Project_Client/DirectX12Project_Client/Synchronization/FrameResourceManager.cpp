...
ID3D12GraphicsCommandList* FrameResourceManager::GetCurrentFrameResourceMainThreadCommandList() const
{
	return frame_resources_[current_frame_index_]->GetMainThreadCommandList();
}
